...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticemailRestfulApi.DomainsApi();
  });
  ...
  describe('DomainsApi', function() {
    ...
    describe('domainsDomainPut', function() {
      it('should call domainsDomainPut successfully', function(done) {
        //uncomment below and update the code to test domainsDomainPut
        //instance.domainsDomainPut(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('domainsDomainVerificationPut', function() {
      it('should call domainsDomainVerificationPut successfully', function(done) {
        //uncomment below and update the code to test domainsDomainVerificationPut
        //instance.domainsDomainVerificationPut(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();

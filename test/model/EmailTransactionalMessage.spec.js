...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticemailRestfulApi.EmailTransactionalMessage();
  });
  ...
  describe('EmailTransactionalMessage', function() {
    it('should create an instance of EmailTransactionalMessage', function() {
      // uncomment below and update the code to test EmailTransactionalMessage
      //var instane = new ElasticemailRestfulApi.EmailTransactionalMessage();
      //expect(instance).to.be.a(ElasticemailRestfulApi.EmailTransactionalMessage);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticemailRestfulApi.ListPayload();
  });
  ...
  describe('ListPayload', function() {
    it('should create an instance of ListPayload', function() {
      ...
      //var instane = new ElasticemailRestfulApi.ListPayload();
      //expect(instance).to.be.a(ElasticemailRestfulApi.ListPayload);
    });
    ...
    it('should have the property createEmptyList (base name: "CreateEmptyList")', function() {
      // uncomment below and update the code to test the property createEmptyList
      //var instane = new ElasticemailRestfulApi.ListPayload();
      //expect(instance).to.be();
    });

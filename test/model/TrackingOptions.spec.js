...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticemailRestfulApi.TrackingOptions();
  });
  ...
  describe('TrackingOptions', function() {
    it('should create an instance of TrackingOptions', function() {
      ...
      //var instane = new ElasticemailRestfulApi.TrackingOptions();
      //expect(instance).to.be.a(ElasticemailRestfulApi.TrackingOptions);
    });

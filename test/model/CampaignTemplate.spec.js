...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticemailRestfulApi.CampaignTemplate();
  });
  ...
  describe('CampaignTemplate', function() {
    it('should create an instance of CampaignTemplate', function() {
      ...
      //var instane = new ElasticemailRestfulApi.CampaignTemplate();
      //expect(instance).to.be.a(ElasticemailRestfulApi.CampaignTemplate);
    });

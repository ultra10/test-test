...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticemailRestfulApi.CampaignListPayload();
  });
  ...
  describe('CampaignListPayload', function() {
    it('should create an instance of CampaignListPayload', function() {
      // uncomment below and update the code to test CampaignListPayload
      //var instane = new ElasticemailRestfulApi.CampaignListPayload();
      //expect(instance).to.be.a(ElasticemailRestfulApi.CampaignListPayload);
    });

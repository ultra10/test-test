...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticemailRestfulApi.CampaignRecipient();
  });
  ...
  describe('CampaignRecipient', function() {
    it('should create an instance of CampaignRecipient', function() {
      ...
      //var instane = new ElasticemailRestfulApi.CampaignRecipient();
      //expect(instance).to.be.a(ElasticemailRestfulApi.CampaignRecipient);
    });

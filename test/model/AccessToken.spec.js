...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticemailRestfulApi.AccessToken();
  });
  ...
  describe('AccessToken', function() {
    it('should create an instance of AccessToken', function() {
      ...
      //var instane = new ElasticemailRestfulApi.AccessToken();
      //expect(instance).to.be.a(ElasticemailRestfulApi.AccessToken);
    });

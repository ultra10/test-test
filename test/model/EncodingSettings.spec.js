...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticemailRestfulApi.EncodingSettings();
  });
  ...
  describe('EncodingSettings', function() {
    it('should create an instance of EncodingSettings', function() {
      // uncomment below and update the code to test EncodingSettings
      //var instane = new ElasticemailRestfulApi.EncodingSettings();
      //expect(instance).to.be.a(ElasticemailRestfulApi.EncodingSettings);
    });

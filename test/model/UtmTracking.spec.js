...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticemailRestfulApi.UtmTracking();
  });
  ...
  describe('UtmTracking', function() {
    it('should create an instance of UtmTracking', function() {
      // uncomment below and update the code to test UtmTracking
      //var instane = new ElasticemailRestfulApi.UtmTracking();
      //expect(instance).to.be.a(ElasticemailRestfulApi.UtmTracking);
    });

# ElasticemailRestfulApi.AccessToken

## Properties
Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**accessLevel** | **String** | Access which this Token grants | 
**name** | **String** | Filename | 
**lastUse** | **Date** | When was this AccessToken used last | [optional] 
...
* `ViewJourneys` (value: `"ViewJourneys"`)
...
* `ModifyJourneys` (value: `"ModifyJourneys"`)
